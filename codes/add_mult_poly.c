...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * {0,0,3,265232453,1301075987}) + ((((uint64_t)op[1] * {0,0,2,1966732964,382641100}) + ((uint64_t)op[2] * {0,0,1,463745936,29416710}) + ((uint64_t)op[3] * {0,0,0,566067269,1998375154}) + ((uint64_t)op[4] * {0,0,0,857916278,688778796}) + ((uint64_t)op[5] * {0,0,1,614080720,1951589506}) + ((uint64_t)op[6] * {0,0,1,2127892607,1859236758}) + ((uint64_t)op[7] * {0,0,1,1380410500,1747721376}) + ((uint64_t)op[8] * {0,0,1,1844767645,1907583688}) + ((uint64_t)op[9] * {0,0,2,2050867106,1873368180})) * 18446744073709551614);
