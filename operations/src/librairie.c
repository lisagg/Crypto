...
void internal_reduction(int32_t *rop, int32_t *op){ // int 64 et int 128
	...
	mult_128(op[0], {0,0,3,265232453,1301075987},tempo_res[0]);
	mult_128(op[1],{0,0,2,1966732964,382641100}, tempo_res [1]);
	mult_128(op[2], {0,0,1,463745936,29416710}, tempo_res[2]);
	mult_128(op[3], {0,0,0,566067269,1998375154}, tempo_res[3]);
	mult_128(op[4], {0,0,0,857916278,688778796}, tempo_res[4]);
	mult_128(op[5], {0,0,1,614080720,1951589506}, tempo_res[5]);
	mult_128(op[6], {0,0,1,2127892607,1859236758}, tempo_res[6]);
	mult_128(op[7], {0,0,1,1380410500,1747721376}, tempo-res[7]);
	mult_128(op[8], {0,0,1,1844767645,1907583688}, tempo_res[8]);
	mult_128(op[9], {0,0,2,2050867106,1873368180},tempo_res[9]);
	...
	mult_128(tmp_q[0], tempo_res2, {0,0, 3, 2147483647, 2147483646});
